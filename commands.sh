python3 train_single.py --train_path 'data/processed_graphs/rus/gat/reif_train' \
--eval_path 'data/processed_graphs/rus/gat/reif_eval' \
--test_path 'data/processed_graphs/rus/gat/reif_test' \
...
--eval 'data/processed_data/rus/eval_src' --eval_ref 'data/tokenized/rus/eval_tgt'
